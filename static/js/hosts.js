...
function submitForm(formId) {
	...
	var postData = "id="+id+"&role="+role+"&priip1="+priip1.value+"&priip2="+priip2.value+"&pubip1="+pubip1.value+"&pubip2="+pubip2.value+"&model="+model+"&cpu="+cpu+"&hdd="+hdd+"&mem="+mem+"&os="+os+"&adminip="+adminip+"&rnum="+rnum+"&storagedate="+storagedate+"&startdate="+startdate+"&idc="+idc+"&idctag="+idctag+"&status="+status+"&comment="+comment;
